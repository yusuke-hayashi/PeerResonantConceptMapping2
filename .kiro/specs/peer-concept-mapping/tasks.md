...
- [x] 5.6 プロパティテスト: 所有者ベースのアクセス制御
  - **プロパティ11: 所有者ベースのアクセス制御**
  - **検証対象: 要件 5.1, 5.2, 5.3, 5.4**

- [x] 5.7 プロパティテスト: トピック別の整理
  - **プロパティ17: トピック別の整理**
  - **検証対象: 要件 9.3**
...
- [x] 6. チェックポイント - すべてのテストが通ることを確認
  ...
  - shared: 12テストパス、workers: 30テストパス（合計42テスト）
...
- [x] 8.2 プロパティテスト: 語彙調整の必須実行
  - **プロパティ8: 語彙調整の必須実行**
  - **検証対象: 要件 3.5**

- [x] 8.3 プロパティテスト: トピック境界の尊重
  - **プロパティ16: トピック境界の尊重**
  - **検証対象: 要件 9.2**
...
- [x] 9.1 プロパティテスト: 比較のデフォルト非公開性
  - **プロパティ9: 比較のデフォルト非公開性**
  - **検証対象: 要件 4.1**

- [x] 9.2 プロパティテスト: 権限のラウンドトリップ
  - **プロパティ10: 権限のラウンドトリップ**
  - **検証対象: 要件 4.2, 4.3, 4.4, 6.1, 6.3**

- [x] 10. チェックポイント - すべてのテストが通ることを確認
  - すべてのテストが通ることを確認し、問題があればユーザーに質問する
  - shared: 12テストパス、workers: 58テストパス（合計70テスト）
